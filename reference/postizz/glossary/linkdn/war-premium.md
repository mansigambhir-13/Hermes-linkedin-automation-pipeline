# war-premium — LinkedIn (v6 green card)
...
**Image:** `visuals/retail-investor-crisis-investing/visual-1.png`
**Render:** `war-premium.png`

## On-card copy

- **Masthead:** The Business Glossary
- **Headline (rainbow-filled):** War Premium
- **Body (brand-voice, engaging; company/personality named in the prose):**

When conflict threatens supply, the price of oil carries a fee that has nothing to do with how much is pumped. It is the market pricing in fear.
...
#Investing #Markets #BusinessStrategy
