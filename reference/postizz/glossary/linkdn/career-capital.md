# career-capital — LinkedIn (v6 green card)
...
**Image:** `visuals/young-professional-career-capital-design/visual-0-cover.png`
**Render:** `career-capital.png`

## On-card copy

- **Masthead:** The Business Glossary
- **Headline (rainbow-filled):** Career Capital
...
Cal Newport called it career capital — the stock of hard-won skills that compounds. Each new capability makes the others worth more. Titles sit still. Capital builds on itself.
...
#CareerDevelopment #Skills #BusinessStrategy
