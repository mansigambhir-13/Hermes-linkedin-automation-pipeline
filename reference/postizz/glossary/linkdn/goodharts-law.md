# goodharts-law — LinkedIn (v6 green card)
...
**Image:** `visuals/young-professional-second-order-thinking/visual-0-cover.png`
**Render:** `goodharts-law.png`

## On-card copy

- **Masthead:** The Business Glossary
- **Headline (rainbow-filled):** Goodhart's Law
...
Economist Charles Goodhart noticed it in 1975. The moment a measure becomes the thing you reward, people optimise the number instead of the outcome it was meant to track. The metric quietly stops telling the truth.
...
#SystemsThinking #Incentives #BusinessStrategy
