# aladdin — LinkedIn (v6 green card)
...
**Image:** `visuals/strategic-analyst-thesis-construction/visual-1.png`
**Render:** `aladdin.png`

## On-card copy

- **Masthead:** The Business Glossary
- **Headline (rainbow-filled):** Aladdin
- **Body (brand-voice, engaging; company/personality named in the prose):**

One piece of software watches over more money than most economies produce. It is called Aladdin.
...
#Finance #Investing #BusinessStrategy
