# task-unbundling — LinkedIn (v6 green card)
...
**Image:** `visuals/senior-leader-task-anatomy/visual-0-cover.png`
**Render:** `task-unbundling.png`

## On-card copy

- **Masthead:** The Business Glossary
- **Headline (rainbow-filled):** Task Unbundling
- **Body (brand-voice, engaging; company/personality named in the prose):**

Automation does not replace jobs. It replaces tasks, and a job is just a bundle of them.
