# leverage-point — LinkedIn (v6 green card)
...
**Course:** `young-professional-leverage-point-identification`
**Image:** `visuals/young-professional-leverage-point-identification/visual-0-cover.png`
**Render:** `leverage-point.png`

## On-card copy

- **Masthead:** The Business Glossary
- **Headline (rainbow-filled):** Leverage Point
- **Body (brand-voice, engaging; company/personality named in the prose):**

In every system there is a spot where a small push moves everything. Find it and you barely have to shove.
