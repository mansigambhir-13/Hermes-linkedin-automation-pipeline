# one-month-manual-rule — LinkedIn (v6 green card)
...
**Course:** `senior-leader-task-anatomy`
**Image:** `visuals/senior-leader-task-anatomy/visual-1.png`
**Render:** `one-month-manual-rule.png`

## On-card copy

- **Masthead:** The Business Glossary
- **Headline (rainbow-filled):** One-Month Manual Rule
- **Body (brand-voice, engaging; company/personality named in the prose):**

Want to know if a task can be automated? Ask how long it would take to teach from a manual.
...
#FutureOfWork #Automation #BusinessStrategy
