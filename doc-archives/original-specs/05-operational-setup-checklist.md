...
- [ ] **Meta / Instagram publishing access** (longest lead time, ~2–4 weeks for app review):
  ...
  - [ ] Assign an owner with Business-account admin access (code can't do this; a person must).
- [ ] **LinkedIn API access**:
...
- [ ] **Locked CTA style** — the exact call-to-action wording/format the team wants on posts.
- [ ] **Per-platform hashtag sets** — the fixed LinkedIn set and the Instagram block. (If a canonical set already exists, hand it over verbatim and note the exact count so it's not mislabeled.)
...
- [ ] **2–5 reference images** of the look you want (the brief-cover illustration style is a strong reference) — these anchor the carousel style spec and lift consistency.
...
- [ ] **Caption quality gate (Phase 1):** ~15 real ideas drafted; on-brand and publishable with light edits, judged against the Brand & Voice Spec bar.
